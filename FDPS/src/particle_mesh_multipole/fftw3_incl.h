#pragma once
/*
 * This file was created for the purpose of workarounding the problem
 * that a compilation error occurs when compiling a source code that
 * includes arm_sve.h with the FFTW3 module loaded.
 * The implementation below is based on fftw3.h in the library of
