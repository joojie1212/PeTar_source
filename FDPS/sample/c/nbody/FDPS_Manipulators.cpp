...
namespace FDPS_Manipulators {
   ...
   void set_particle_local_tree(const int tree_num, 
      ...
      if (info == "full_particle,Long,full_particle,full_particle,full_particle,Monopole") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::Monopole *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::Monopole *) tree_ptr;
         PS::ParticleSystem<full_particle> *psys;
         psys = (PS::ParticleSystem<full_particle> *) psys_ptr;
         tree->setParticleLocalTree(*psys,clear);
      
      } else if (info == "full_particle,Long,full_particle,full_particle,full_particle,Quadrupole") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::Quadrupole *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::Quadrupole *) tree_ptr;
         PS::ParticleSystem<full_particle> *psys;
         psys = (PS::ParticleSystem<full_particle> *) psys_ptr;
         tree->setParticleLocalTree(*psys,clear);
      
      } else if (info == "full_particle,Long,full_particle,full_particle,full_particle,MonopoleGeometricCenter") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::MonopoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::MonopoleGeometricCenter *) tree_ptr;
         PS::ParticleSystem<full_particle> *psys;
         psys = (PS::ParticleSystem<full_particle> *) psys_ptr;
         tree->setParticleLocalTree(*psys,clear);
      
      } else if (info == "full_particle,Long,full_particle,full_particle,full_particle,DipoleGeometricCenter") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::DipoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::DipoleGeometricCenter *) tree_ptr;
         PS::ParticleSystem<full_particle> *psys;
         psys = (PS::ParticleSystem<full_particle> *) psys_ptr;
         tree->setParticleLocalTree(*psys,clear);
      
      } else if (info == "full_particle,Long,full_particle,full_particle,full_particle,QuadrupoleGeometricCenter") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::QuadrupoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::QuadrupoleGeometricCenter *) tree_ptr;
         PS::ParticleSystem<full_particle> *psys;
         psys = (PS::ParticleSystem<full_particle> *) psys_ptr;
         tree->setParticleLocalTree(*psys,clear);
      ...
      for (std::vector<Tree_Data>::iterator it = tree_vector.begin(); it != tree_vector.end(); ++it) {
         if (it->id == tree_num) {
            ...
            if (it->info == "Long,full_particle,full_particle,full_particle,Monopole") {
               ...
               tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::Monopole *) it->ptr;
               full_particle *force;
               force = (full_particle *) cptr_to_force;
   ...
   void calc_force_making_tree(const int tree_num, 
      ...
      if (info == "Long,full_particle,full_particle,full_particle,Monopole") {
      ...
      } else if (info == "Long,full_particle,full_particle,full_particle,Quadrupole") {
         // Set the pointer to tree
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::Quadrupole *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::Quadrupole *) tree_ptr;
         // Perform API
      ...
      } else if (info == "Long,full_particle,full_particle,full_particle,MonopoleGeometricCenter") {
         // Set the pointer to tree
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::MonopoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::MonopoleGeometricCenter *) tree_ptr;
         // Perform API
      ...
      } else if (info == "Long,full_particle,full_particle,full_particle,DipoleGeometricCenter") {
         // Set the pointer to tree
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::DipoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::DipoleGeometricCenter *) tree_ptr;
         // Perform API
      ...
      } else if (info == "Long,full_particle,full_particle,full_particle,QuadrupoleGeometricCenter") {
         // Set the pointer to tree
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::QuadrupoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::QuadrupoleGeometricCenter *) tree_ptr;
         // Perform API
   ...
   void * get_epj_from_id(const int tree_num,
      ...
      if (tree_info == "Long,full_particle,full_particle,full_particle,Monopole") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::Monopole *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::Monopole *) tree_ptr;
         struct full_particle * epj;
         epj = tree->getEpjFromId(id);
         return (void *) epj;
      
      } else if (tree_info == "Long,full_particle,full_particle,full_particle,Quadrupole") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::Quadrupole *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::Quadrupole *) tree_ptr;
         struct full_particle * epj;
         epj = tree->getEpjFromId(id);
      ...
      } else if (tree_info == "Long,full_particle,full_particle,full_particle,MonopoleGeometricCenter") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::MonopoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::MonopoleGeometricCenter *) tree_ptr;
         struct full_particle * epj;
         epj = tree->getEpjFromId(id);
      ...
      } else if (tree_info == "Long,full_particle,full_particle,full_particle,DipoleGeometricCenter") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::DipoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::DipoleGeometricCenter *) tree_ptr;
         struct full_particle * epj;
         epj = tree->getEpjFromId(id);
      ...
      } else if (tree_info == "Long,full_particle,full_particle,full_particle,QuadrupoleGeometricCenter") {
         PS::TreeForForceLong<full_particle,full_particle,full_particle>::QuadrupoleGeometricCenter *tree;
         tree = (PS::TreeForForceLong<full_particle,full_particle,full_particle>::QuadrupoleGeometricCenter *) tree_ptr;
         struct full_particle * epj;
         epj = tree->getEpjFromId(id);
